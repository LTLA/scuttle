...
aggregate_across_cells <- function(x, groups, num_groups, do_sum, do_detected, num_threads) {
    .Call(`_scuttle_aggregate_across_cells`, x, groups, num_groups, do_sum, do_detected, num_threads)
}
